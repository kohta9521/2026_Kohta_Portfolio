  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        period: "2022.09",
        title: "Enter",
        desc: "Part community, part product — a place for university-student engineers across Japan to connect beyond their own specialisms. Discord-run operations on one side, a members' platform built in React / Next.js / Laravel / Go on the other, both folded into one idea: connect, build, grow, learn.",
      ...
      },
      {
        ...
        desc: "A spring welcome festival turning new-student season into a single culture — fourteen student groups from wildly different fields, one venue. I led the whole thing as festival chair, from concept to sponsorship to running the day and building the official site.",
        role: "Festival Chair · Concept to Operations",
        body: [
